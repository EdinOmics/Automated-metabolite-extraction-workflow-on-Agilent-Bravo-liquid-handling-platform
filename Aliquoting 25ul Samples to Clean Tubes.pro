...
<Velocity11 file='Protocol_Data' md5sum='6a40e072cef8c63c9e648653630ffeb5' version='2.0' >
	...
	<Processes >
		<Main_Processes >
			<Process >
				...
				<Task Name='Bravo::SubProcess' >
					...
					<Parameters >
						...
						<Parameter Category='Static labware configuration' Name='5' Value='24-well 1.5 mL Eppendorf tube' />
			...
			<Process >
				...
				<Plate_Parameters >
					<Parameter Name='Plate name' Value='Empty Tubes' />
					<Parameter Name='Plate type' Value='24-well 1.5 mL Eppendorf tube' />
					<Parameter Name='Simultaneous plates' Value='1' />
					<Parameter Name='Plates have lids' Value='0' />
					<Parameter Name='Plates enter the system sealed' Value='0' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Dispense' Task_Type='2' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='Empty Tubes' />
						<Parameter Category='' Name='Location, location' Value='&lt;auto-select&gt;' />
